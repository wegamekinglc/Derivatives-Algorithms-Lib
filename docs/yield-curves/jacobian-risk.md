...
(see [Yield Curve Construction](construction.md) and
[Underdetermined search](../methodology/underdetermined_search.md) for the calibration itself):
...
[single-curve AAD calibration internals](construction.md#single-curve-aad-calibration-internals)),
...
(see [AAD methodology — Tape-Layer Primitives for Curve Calibration](../methodology/aad.md#tape-layer-primitives-for-curve-calibration)
...
global over the cubic tail. See [Log-discount curve](log-discount.md).
...
[Residual Scaling](../methodology/underdetermined_search.md#residual-scaling)); equivalently,
...
- [Yield Curve Construction](construction.md) — the calibration that produces
  `effJacobianInverse_`.
- [Underdetermined search](../methodology/underdetermined_search.md) — the solver whose residual
  scaling motivates the `/tolerance_` correction.
- [AAD methodology](../methodology/aad.md) — the reverse-mode machinery behind the analytic
  Jacobian.
- [Single-curve AAD calibration internals](construction.md#single-curve-aad-calibration-internals)
