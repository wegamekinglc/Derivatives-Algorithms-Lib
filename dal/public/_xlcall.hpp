...
typedef struct xloper {
    ...
    union {
        ...
        __nullterminated char* str; /* xltypeStr */
#ifdef __cplusplus
        unsigned short xbool; /* xltypeBool */
#else
        unsigned short bool; /* xltypeBool */
#endif
        unsigned short err; /* xltypeErr */
...
extern "C" int _stdcall Excel4v(int xlfn, LPXLOPER operRes, int count, LPXLOPER opers[]);
