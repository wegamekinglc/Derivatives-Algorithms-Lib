...
namespace Dal {
    namespace {
        ...
        Interp1_* MakeNcdfSpline() {
            static const Vector_<> x = {MIN_SPLINE_X, -3.347382781, -3.030883722, -2.75090681,
            ...
            static const Vector_<> f = {MIN_SPLINE_F, 0.000408582, 0.001219907, 0.002972237, 0.00634685, 0.012444548,
