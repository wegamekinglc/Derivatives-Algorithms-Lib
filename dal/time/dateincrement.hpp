...
namespace Dal {
    ...
    inline Date_ operator+(const Date_& date, const Date::Increment_& inc) { return inc.FwdFrom(date); }

    inline Date_ operator-(const Date_& date, const Date::Increment_& inc) { return inc.BackFrom(date); }
