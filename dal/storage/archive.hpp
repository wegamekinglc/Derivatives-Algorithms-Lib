...
namespace Dal::Archive {
    ...
    public:
        ...
        [[nodiscard]] virtual String_ AsString() const = 0;
        [[nodiscard]] virtual Date_ AsDate() const = 0;
        [[nodiscard]] virtual Dictionary_ AsDictionary() const = 0;
        [[nodiscard]] virtual Vector_<> AsDoubleVector() const = 0;
        [[nodiscard]] virtual Vector_<int> AsIntVector() const = 0;
        [[nodiscard]] virtual Vector_<bool> AsBoolVector() const = 0;
        [[nodiscard]] virtual Vector_<String_> AsStringVector() const = 0;
        [[nodiscard]] virtual Vector_<Date_> AsDateVector() const = 0;
        [[nodiscard]] virtual Vector_<DateTime_> AsDateTimeVector() const = 0;
        [[nodiscard]] virtual Vector_<Cell_> AsCellVector() const = 0;
        [[nodiscard]] virtual Matrix_<> AsDoubleMatrix() const = 0;
        [[nodiscard]] virtual Matrix_<String_> AsStringMatrix() const = 0;
        [[nodiscard]] virtual Matrix_<Cell_> AsCellMatrix() const = 0;

        // query composite types
        [[nodiscard]] virtual String_ Type() const = 0;
        [[nodiscard]] virtual const View_& Child(const String_& name) const = 0;
        [[nodiscard]] virtual bool HasChild(const String_& name) const = 0;
        [[nodiscard]] const View_& Element(int index) const;
        [[nodiscard]] bool HasElement(int index) const;
    ...
    public:
        ...
        [[nodiscard]] virtual Storable_* Build() const = 0;
