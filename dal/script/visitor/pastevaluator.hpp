...
namespace Dal::Script {
    ...
    public:
        ...
        explicit PastEvaluatorBase_(size_t nVar) : variables_(nVar) {}

        // Copy/Move
        PastEvaluatorBase_(const PastEvaluatorBase_& rhs) : variables_(rhs.variables_) {}
        PastEvaluatorBase_& operator=(const PastEvaluatorBase_& rhs) {
            if (this == &rhs)
                return *this;
        ...
        PastEvaluatorBase_(PastEvaluatorBase_&& rhs) noexcept : variables_(std::move(rhs.variables_)) {}
        PastEvaluatorBase_& operator=(PastEvaluatorBase_&& rhs) noexcept {
    ...
    template <class T_>
    class PastEvaluator_ : public PastEvaluatorBase_<T_, PastEvaluator_> {

    public:
        using Base = PastEvaluatorBase_<T_, PastEvaluator_>;

        explicit PastEvaluator_(size_t nVar) : Base(nVar) {}
        PastEvaluator_(const PastEvaluator_& rhs) : Base(rhs) {}
        PastEvaluator_(PastEvaluator_&& rhs) noexcept: Base(std::move(rhs)) {}
