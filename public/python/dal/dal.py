...
def BSModelData_New(spot, vol, rate, div):
    r"""
...
def DupireModelData_New(spot, rate, repo, spots, times, vols):
    r"""
...
def PseudoRSG_Get_Uniform(rsg, num_path):
    r"""
...
def PseudoRSG_Get_Normal(rsg, num_path):
    r"""
...
def SobolRSG_New(i_path, ndim=1):
    r"""
...
def SobolRSG_Get_Uniform(rsg, num_path):
    r"""
...
def SobolRSG_Get_Normal(rsg, num_path):
    r"""
