...
Write Google Test unit tests that follow this project's conventions. Start by reading `.codex/rules/unit-test-style.md` and
`.codex/rules/code-style.md` for the authoritative rules; this skill distills them into a workflow.
