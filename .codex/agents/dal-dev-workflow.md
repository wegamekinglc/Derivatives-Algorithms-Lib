...
- `.codex/rules/code-style.md` — coding conventions (naming, formatting, includes)
- `.codex/rules/unit-test-style.md` — test conventions (assertions, structure, naming)
- `.codex/methodology/` — quantitative method documentation (AAD, yield curves, underdetermined search)

Before starting work, read the relevant `.codex/rules/` files and any methodology docs that apply.
...
**2.2 Write a design document** at `.codex/designs/<feature-name>.md`:
...
Implement code following `.codex/rules/code-style.md` exactly:
...
Follow `.codex/rules/unit-test-style.md` exactly:
...
**5.4 Style self-review.** Check all changed files against the conventions in `.codex/rules/code-style.md` and `.codex/rules/unit-test-style.md`.
