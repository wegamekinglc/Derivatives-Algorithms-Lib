...
- [ ] A new unit test under `dal-cpp/tests/curve/` (e.g. `test_joint_calibration.cpp`) calibrates a
  ...
  tight tolerance. Test style follows `.codex/skills/dal-agent-team/references/unit-test-style.md`.
...
- [ ] The file header matches the three-line convention; the code passes
  `.codex/skills/dal-agent-team/references/code-style.md` (4-space indent, 150-col limit, `using namespace Dal;`, PascalCase
