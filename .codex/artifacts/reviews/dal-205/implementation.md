...
- Initial COM-runner failures were local format assignment and Boolean Value2 persistence; corrected runner replays pass. The consumer first used exact floating equality and was corrected to the already-approved PV tolerance; its actual value is recorded above.
