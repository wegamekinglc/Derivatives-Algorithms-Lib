...
if (MSVC)
    ...
    if (CMAKE_BUILD_TYPE STREQUAL "Debug")
        SET(MSVC_COMPILER_OPTION /wd4267 /wd26812 /std:c++20)
    else()
        SET(MSVC_COMPILER_OPTION /wd4267 /wd26812 /std:c++20 /Qpar /Gy /arch:AVX2 /Oi /GL /Ot /Oy)
    endif()
...
elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
    ...
    if ("${USE_COVERAGE}" STREQUAL "true")
        set(CMAKE_CXX_FLAGS "-O3 -march=native -fprofile-instr-generate -fcoverage-mapping")
    else()
    ...
    set(CMAKE_EXPORT_COMPILE_COMMANDS ON)
    if ("${USE_COVERAGE}" STREQUAL "true")
        set(CMAKE_CXX_FLAGS "-O3 -march=native -ftest-coverage -fprofile-arcs")
    else()
        set(CMAKE_CXX_FLAGS "-O3 -march=native")
    endif()
    message("-- CMAKE_CXX_FLAGS: ${CMAKE_CXX_FLAGS}")
