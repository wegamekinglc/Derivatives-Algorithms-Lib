...
elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
    ...
    if ("${SKIP_TESTS}" STREQUAL "false")
        set(CMAKE_CXX_FLAGS "-mcpu=native -fprofile-instr-generate -fcoverage-mapping")
    else()
        set(CMAKE_CXX_FLAGS "-mcpu=native")
    endif()
    message("-- CMAKE_CXX_FLAGS: ${CMAKE_CXX_FLAGS}")
else()
    set(CMAKE_EXPORT_COMPILE_COMMANDS ON)
    if ("${SKIP_TESTS}" STREQUAL "false")
        set(CMAKE_CXX_FLAGS "-mcpu=native -ftest-coverage -fprofile-arcs")
    else()
        set(CMAKE_CXX_FLAGS "-mcpu=native")
    endif()
    message("-- CMAKE_CXX_FLAGS: ${CMAKE_CXX_FLAGS}")
