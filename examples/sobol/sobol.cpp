...
int main() {
    ...
    for (auto i: p_num_paths) {
        ...
        std::cout << std::fixed
                  ...
                  << std::setw(widths[1]) << std::right << uniform_duration
                  << std::setw(widths[2]) << std::right << normal_duration
                  << std::endl;
