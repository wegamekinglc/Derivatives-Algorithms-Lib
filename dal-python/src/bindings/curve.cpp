...
void init_bindings_curve(py::module_& m) {
    ...
    // =======================================================================
    // CurveCalibrationDiagnostics_ (read-only)
    // =======================================================================
    ...
    // CrossCurrencyCalibrationDiagnostics_ (read-only)
    ...
    // CrossCurrencyFxForwardCurve_ (read-only)
    ...
    // CrossCurrencyCalibrationResult_ (read-only)
